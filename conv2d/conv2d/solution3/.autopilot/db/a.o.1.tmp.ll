; ModuleID = 'E:/vivado/conv2d/conv2d/solution3/.autopilot/db/a.o.1.tmp.bc'
...
; <label>:1                                       ; preds = %8, %0
  ...
  %exitcond3 = icmp eq i16 %i, 3, !dbg !264       ; [#uses=1 type=i1] [debug line = 9:23]
...
; <label>:3                                       ; preds = %1
  ...
  %tmp = zext i16 %i to i64, !dbg !266            ; [#uses=1 type=i64] [debug line = 13:7]
  %i.t = trunc i16 %i to i3                       ; [#uses=9 type=i3]
  br label %4, !dbg !267                          ; [debug line = 11:25]

; <label>:4                                       ; preds = %branch42228, %3
  %j = phi i16 [ 0, %3 ], [ %j.1, %branch42228 ]  ; [#uses=4 type=i16]
  %exitcond2 = icmp eq i16 %j, 3, !dbg !267       ; [#uses=1 type=i1] [debug line = 11:25]
...
; <label>:6                                       ; preds = %4
  ...
  %tmp.3 = zext i16 %j to i64, !dbg !266          ; [#uses=1 type=i64] [debug line = 13:7]
  %res.addr = getelementptr [3 x [3 x i16]]* %res, i64 0, i64 %tmp, i64 %tmp.3, !dbg !266 ; [#uses=1 type=i16*] [debug line = 13:7]
  %j.t = trunc i16 %j to i3                       ; [#uses=27 type=i3]
  switch i3 %i.t, label %branch2 [
    i3 0, label %branch0
    i3 1, label %branch1
...
branch012:                                        ; preds = %branch275, %branch173, %branch42227, %branch41225, %branch217, %branch013, %branch2, %branch1, %branch0
  ...
  %tmp.10 = sext i8 %a.load.0.0.phi to i16, !dbg !254 ; [#uses=1 type=i16] [debug line = 16:21]
  %"b[0][0].load" = load i8* %"b[0][0]", align 1, !dbg !254 ; [#uses=1 type=i8] [debug line = 16:21]
  %tmp.12 = sext i8 %"b[0][0].load" to i16, !dbg !254 ; [#uses=1 type=i16] [debug line = 16:21]
  %tmp.13 = mul i16 %tmp.10, %tmp.12, !dbg !254   ; [#uses=1 type=i16] [debug line = 16:21]
  switch i3 %i.t, label %branch7 [
    i3 0, label %branch5
    i3 1, label %branch6
  ], !dbg !254                                    ; [debug line = 16:21]
...
branch537:                                        ; preds = %branch8109, %branch7107, %branch38212, %branch37210, %branch844, %branch742, %branch7, %branch6, %branch5
  ...
  %tmp.14.0.1 = add i16 %tmp.13.0.1, %tmp.13, !dbg !254 ; [#uses=1 type=i16] [debug line = 16:21]
  switch i3 %i.t, label %branch12 [
    i3 0, label %branch10
    i3 1, label %branch11
  ], !dbg !254                                    ; [debug line = 16:21]
...
branch1067:                                       ; preds = %branch14133, %branch13131, %branch34197, %branch33195, %branch1476, %branch1374, %branch12, %branch11, %branch10
  ...
  %tmp.14.0.2 = add i16 %tmp.13.0.2, %tmp.14.0.1, !dbg !254 ; [#uses=1 type=i16] [debug line = 16:21]
  switch i3 %i.t, label %branch18 [
    i3 0, label %branch16
    i3 1, label %branch17
  ], !dbg !254                                    ; [debug line = 16:21]
...
branch16171:                                      ; preds = %branch27238, %branch26236, %branch17148, %branch16146, %branch27176, %branch26174, %branch18, %branch17, %branch16
  ...
  %tmp.14.1 = add i16 %tmp.14.0.2, %tmp.13.1, !dbg !254 ; [#uses=1 type=i16] [debug line = 16:21]
  switch i3 %i.t, label %branch23 [
    i3 0, label %branch21
    i3 1, label %branch22
  ], !dbg !254                                    ; [debug line = 16:21]
...
branch21154:                                      ; preds = %branch23223, %branch22221, %branch23167, %branch22165, %branch23161, %branch22159, %branch23, %branch22, %branch21
  ...
  %tmp.14.1.1 = add i16 %tmp.14.1, %tmp.13.1.1, !dbg !254 ; [#uses=1 type=i16] [debug line = 16:21]
  switch i3 %i.t, label %branch28 [
    i3 0, label %branch26
    i3 1, label %branch27
  ], !dbg !254                                    ; [debug line = 16:21]
...
branch26137:                                      ; preds = %branch19207, %branch18205, %branch29186, %branch28184, %branch19146, %branch18144, %branch28, %branch27, %branch26
  ...
  %tmp.14.1.2 = add i16 %tmp.13.1.2, %tmp.14.1.1, !dbg !254 ; [#uses=1 type=i16] [debug line = 16:21]
  switch i3 %i.t, label %branch34 [
    i3 0, label %branch32
    i3 1, label %branch33
  ], !dbg !254                                    ; [debug line = 16:21]
...
branch32194:                                      ; preds = %branch32296, %branch30292, %branch12177, %branch11175, %branch32199, %branch31197, %branch34, %branch33, %branch32
  ...
  %tmp.14.2 = add i16 %tmp.14.1.2, %tmp.13.2, !dbg !254 ; [#uses=1 type=i16] [debug line = 16:21]
  switch i3 %i.t, label %branch39 [
    i3 0, label %branch37
    i3 1, label %branch38
  ], !dbg !254                                    ; [debug line = 16:21]
...
branch37211:                                      ; preds = %branch38315, %branch37313, %branch8132, %branch7130, %branch38218, %branch37216, %branch39, %branch38, %branch37
  ...
  %tmp.14.2.1 = add i16 %tmp.14.2, %tmp.13.2.1, !dbg !254 ; [#uses=1 type=i16] [debug line = 16:21]
  switch i3 %i.t, label %branch44 [
    i3 0, label %branch42
    i3 1, label %branch43
  ], !dbg !254                                    ; [debug line = 16:21]
...
branch42228:                                      ; preds = %branch44334, %branch43332, %branch483, %branch381, %branch44237, %branch43235, %branch44, %branch43, %branch42
  ...
  %tmp.14.2.2 = add i16 %tmp.14.2.1, %tmp.13.2.2, !dbg !254 ; [#uses=1 type=i16] [debug line = 16:21]
  ...
  %j.1 = add i16 %j, 1, !dbg !271                 ; [#uses=1 type=i16] [debug line = 11:42]
  call void @llvm.dbg.value(metadata !{i16 %j.1}, i64 0, metadata !272), !dbg !271 ; [debug line = 11:42] [debug variable = j]
...
; <label>:8                                       ; preds = %4
  ...
  %i.1 = add i16 %i, 1, !dbg !274                 ; [#uses=1 type=i16] [debug line = 9:40]
  call void @llvm.dbg.value(metadata !{i16 %i.1}, i64 0, metadata !275), !dbg !274 ; [debug line = 9:40] [debug variable = i]
...
branch0:                                          ; preds = %6
  switch i3 %j.t, label %branch217 [
    i3 0, label %branch013
    i3 1, label %branch012
  ], !dbg !254                                    ; [debug line = 16:21]

branch1:                                          ; preds = %6
  switch i3 %j.t, label %branch42227 [
    i3 0, label %branch012
    i3 1, label %branch41225
  ], !dbg !254                                    ; [debug line = 16:21]

branch2:                                          ; preds = %6
  switch i3 %j.t, label %branch275 [
    i3 0, label %branch012
    i3 1, label %branch173
  ], !dbg !254                                    ; [debug line = 16:21]

branch5:                                          ; preds = %branch012
  switch i3 %j.t, label %branch844 [
    i3 0, label %branch537
    i3 1, label %branch742
  ], !dbg !254                                    ; [debug line = 16:21]

branch6:                                          ; preds = %branch012
  switch i3 %j.t, label %branch38212 [
    i3 0, label %branch537
    i3 1, label %branch37210
  ], !dbg !254                                    ; [debug line = 16:21]

branch7:                                          ; preds = %branch012
  switch i3 %j.t, label %branch8109 [
    i3 0, label %branch537
    i3 1, label %branch7107
  ], !dbg !254                                    ; [debug line = 16:21]

branch10:                                         ; preds = %branch537
  switch i3 %j.t, label %branch1476 [
    i3 0, label %branch1067
    i3 1, label %branch1374
  ], !dbg !254                                    ; [debug line = 16:21]

branch11:                                         ; preds = %branch537
  switch i3 %j.t, label %branch34197 [
    i3 0, label %branch1067
    i3 1, label %branch33195
  ], !dbg !254                                    ; [debug line = 16:21]

branch12:                                         ; preds = %branch537
  switch i3 %j.t, label %branch14133 [
    i3 0, label %branch1067
    i3 1, label %branch13131
  ], !dbg !254                                    ; [debug line = 16:21]

branch16:                                         ; preds = %branch1067
  switch i3 %j.t, label %branch27176 [
    i3 0, label %branch16171
    i3 1, label %branch26174
  ], !dbg !254                                    ; [debug line = 16:21]

branch17:                                         ; preds = %branch1067
  switch i3 %j.t, label %branch17148 [
    i3 0, label %branch16171
    i3 1, label %branch16146
  ], !dbg !254                                    ; [debug line = 16:21]

branch18:                                         ; preds = %branch1067
  switch i3 %j.t, label %branch27238 [
    i3 0, label %branch16171
    i3 1, label %branch26236
  ], !dbg !254                                    ; [debug line = 16:21]

branch21:                                         ; preds = %branch16171
  switch i3 %j.t, label %branch23161 [
    i3 0, label %branch21154
    i3 1, label %branch22159
  ], !dbg !254                                    ; [debug line = 16:21]

branch22:                                         ; preds = %branch16171
  switch i3 %j.t, label %branch23167 [
    i3 0, label %branch21154
    i3 1, label %branch22165
  ], !dbg !254                                    ; [debug line = 16:21]

branch23:                                         ; preds = %branch16171
  switch i3 %j.t, label %branch23223 [
    i3 0, label %branch21154
    i3 1, label %branch22221
  ], !dbg !254                                    ; [debug line = 16:21]

branch26:                                         ; preds = %branch21154
  switch i3 %j.t, label %branch19146 [
    i3 0, label %branch26137
    i3 1, label %branch18144
  ], !dbg !254                                    ; [debug line = 16:21]

branch27:                                         ; preds = %branch21154
  switch i3 %j.t, label %branch29186 [
    i3 0, label %branch26137
    i3 1, label %branch28184
  ], !dbg !254                                    ; [debug line = 16:21]

branch28:                                         ; preds = %branch21154
  switch i3 %j.t, label %branch19207 [
    i3 0, label %branch26137
    i3 1, label %branch18205
  ], !dbg !254                                    ; [debug line = 16:21]

branch32:                                         ; preds = %branch26137
  switch i3 %j.t, label %branch32199 [
    i3 0, label %branch32194
    i3 1, label %branch31197
  ], !dbg !254                                    ; [debug line = 16:21]

branch33:                                         ; preds = %branch26137
  switch i3 %j.t, label %branch12177 [
    i3 0, label %branch32194
    i3 1, label %branch11175
  ], !dbg !254                                    ; [debug line = 16:21]

branch34:                                         ; preds = %branch26137
  switch i3 %j.t, label %branch32296 [
    i3 0, label %branch30292
    i3 1, label %branch32194
  ], !dbg !254                                    ; [debug line = 16:21]

branch37:                                         ; preds = %branch32194
  switch i3 %j.t, label %branch38218 [
    i3 0, label %branch37211
    i3 1, label %branch37216
  ], !dbg !254                                    ; [debug line = 16:21]

branch38:                                         ; preds = %branch32194
  switch i3 %j.t, label %branch8132 [
    i3 0, label %branch37211
    i3 1, label %branch7130
  ], !dbg !254                                    ; [debug line = 16:21]

branch39:                                         ; preds = %branch32194
  switch i3 %j.t, label %branch38315 [
    i3 0, label %branch37211
    i3 1, label %branch37313
  ], !dbg !254                                    ; [debug line = 16:21]

branch42:                                         ; preds = %branch37211
  switch i3 %j.t, label %branch44237 [
    i3 0, label %branch42228
    i3 1, label %branch43235
  ], !dbg !254                                    ; [debug line = 16:21]

branch43:                                         ; preds = %branch37211
  switch i3 %j.t, label %branch483 [
    i3 0, label %branch42228
    i3 1, label %branch381
  ], !dbg !254                                    ; [debug line = 16:21]

branch44:                                         ; preds = %branch37211
  switch i3 %j.t, label %branch44334 [
    i3 0, label %branch42228
    i3 1, label %branch43332
  ], !dbg !254                                    ; [debug line = 16:21]
