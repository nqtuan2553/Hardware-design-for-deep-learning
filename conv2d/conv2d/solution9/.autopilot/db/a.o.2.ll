...
; <label>:1                                       ; preds = %8, %0
  %i = phi i3 [ 0, %0 ], [ %i.1, %8 ]             ; [#uses=6 type=i3]
  %i.cast = zext i3 %i to i4, !dbg !103           ; [#uses=2 type=i4] [debug line = 9:21]
  %exitcond3 = icmp eq i3 %i, -3, !dbg !103       ; [#uses=1 type=i1] [debug line = 9:21]
...
; <label>:3                                       ; preds = %1
  ...
  %tmp = zext i3 %i to i64, !dbg !108             ; [#uses=7 type=i64] [debug line = 13:7]
  %i.1 = add i3 %i, 1, !dbg !111                  ; [#uses=2 type=i3] [debug line = 16:21]
  %tmp.5.1 = zext i3 %i.1 to i64, !dbg !111       ; [#uses=6 type=i64] [debug line = 16:21]
  %tmp.4.2 = add i3 %i, 2, !dbg !111              ; [#uses=1 type=i3] [debug line = 16:21]
  %tmp.5.2 = zext i3 %tmp.4.2 to i64, !dbg !111   ; [#uses=6 type=i64] [debug line = 16:21]
  %tmp.4.3 = add i3 %i, 3, !dbg !111              ; [#uses=1 type=i3] [debug line = 16:21]
  %tmp.5.3 = zext i3 %tmp.4.3 to i64, !dbg !111   ; [#uses=6 type=i64] [debug line = 16:21]
  %tmp.4.4 = add i4 %i.cast, 4, !dbg !111         ; [#uses=1 type=i4] [debug line = 16:21]
  %tmp.5.4 = zext i4 %tmp.4.4 to i64, !dbg !111   ; [#uses=6 type=i64] [debug line = 16:21]
  %tmp.4.5 = add i4 %i.cast, 5, !dbg !111         ; [#uses=1 type=i4] [debug line = 16:21]
  %tmp.5.5 = zext i4 %tmp.4.5 to i64, !dbg !111   ; [#uses=6 type=i64] [debug line = 16:21]
  br label %4, !dbg !116                          ; [debug line = 11:23]

; <label>:4                                       ; preds = %6, %3
  %j = phi i3 [ 0, %3 ], [ %j.1, %6 ]             ; [#uses=6 type=i3]
  %j.cast = zext i3 %j to i4, !dbg !116           ; [#uses=2 type=i4] [debug line = 11:23]
  %exitcond2 = icmp eq i3 %j, -3, !dbg !116       ; [#uses=1 type=i1] [debug line = 11:23]
...
; <label>:6                                       ; preds = %4
  ...
  %tmp.2 = zext i3 %j to i64, !dbg !108           ; [#uses=7 type=i64] [debug line = 13:7]
  ...
  %tmp.4 = sext i8 %"b[0].load" to i16, !dbg !111 ; [#uses=1 type=i16] [debug line = 16:21]
  %tmp.7 = mul i16 %tmp.4, %tmp., !dbg !111       ; [#uses=1 type=i16] [debug line = 16:21]
  %j.1 = add i3 %j, 1, !dbg !111                  ; [#uses=2 type=i3] [debug line = 16:21]
  %tmp.9.0.1 = zext i3 %j.1 to i64, !dbg !111     ; [#uses=6 type=i64] [debug line = 16:21]
  ...
  %tmp.8.0.2 = add i3 %j, 2, !dbg !111            ; [#uses=1 type=i3] [debug line = 16:21]
  %tmp.9.0.2 = zext i3 %tmp.8.0.2 to i64, !dbg !111 ; [#uses=6 type=i64] [debug line = 16:21]
  ...
  %tmp.8.0.3 = add i3 %j, 3, !dbg !111            ; [#uses=1 type=i3] [debug line = 16:21]
  %tmp.9.0.3 = zext i3 %tmp.8.0.3 to i64, !dbg !111 ; [#uses=6 type=i64] [debug line = 16:21]
  ...
  %tmp.8.0.4 = add i4 %j.cast, 4, !dbg !111       ; [#uses=1 type=i4] [debug line = 16:21]
  %tmp.9.0.4 = zext i4 %tmp.8.0.4 to i64, !dbg !111 ; [#uses=6 type=i64] [debug line = 16:21]
  ...
  %tmp.8.0.5 = add i4 %j.cast, 5, !dbg !111       ; [#uses=1 type=i4] [debug line = 16:21]
  %tmp.9.0.5 = zext i4 %tmp.8.0.5 to i64, !dbg !111 ; [#uses=6 type=i64] [debug line = 16:21]
  ...
  %tmp4 = add i16 %tmp.7, %tmp.7.0.1, !dbg !111   ; [#uses=1 type=i16] [debug line = 16:21]
  %tmp5 = add i16 %tmp.7.0.3, %tmp.7.0.2, !dbg !111 ; [#uses=1 type=i16] [debug line = 16:21]
  %tmp3 = add i16 %tmp4, %tmp5, !dbg !111         ; [#uses=1 type=i16] [debug line = 16:21]
  %tmp7 = add i16 %tmp.7.0.5, %tmp.7.0.4, !dbg !111 ; [#uses=1 type=i16] [debug line = 16:21]
  %tmp9 = add i16 %tmp.7.1.2, %tmp.7.1.1, !dbg !111 ; [#uses=1 type=i16] [debug line = 16:21]
  %tmp8 = add i16 %tmp.7.1, %tmp9, !dbg !111      ; [#uses=1 type=i16] [debug line = 16:21]
  %tmp6 = add i16 %tmp7, %tmp8, !dbg !111         ; [#uses=1 type=i16] [debug line = 16:21]
  %tmp2 = add i16 %tmp3, %tmp6, !dbg !111         ; [#uses=1 type=i16] [debug line = 16:21]
  %tmp12 = add i16 %tmp.7.1.4, %tmp.7.1.3, !dbg !111 ; [#uses=1 type=i16] [debug line = 16:21]
  %tmp13 = add i16 %tmp.7.2, %tmp.7.1.5, !dbg !111 ; [#uses=1 type=i16] [debug line = 16:21]
  %tmp11 = add i16 %tmp12, %tmp13, !dbg !111      ; [#uses=1 type=i16] [debug line = 16:21]
  %tmp15 = add i16 %tmp.7.2.2, %tmp.7.2.1, !dbg !111 ; [#uses=1 type=i16] [debug line = 16:21]
  %tmp17 = add i16 %tmp.7.2.5, %tmp.7.2.4, !dbg !111 ; [#uses=1 type=i16] [debug line = 16:21]
  %tmp16 = add i16 %tmp.7.2.3, %tmp17, !dbg !111  ; [#uses=1 type=i16] [debug line = 16:21]
  %tmp14 = add i16 %tmp15, %tmp16, !dbg !111      ; [#uses=1 type=i16] [debug line = 16:21]
  %tmp10 = add i16 %tmp11, %tmp14, !dbg !111      ; [#uses=1 type=i16] [debug line = 16:21]
  %tmp1 = add i16 %tmp2, %tmp10, !dbg !111        ; [#uses=1 type=i16] [debug line = 16:21]
  %tmp21 = add i16 %tmp.7.3.1, %tmp.7.3, !dbg !111 ; [#uses=1 type=i16] [debug line = 16:21]
  %tmp22 = add i16 %tmp.7.3.3, %tmp.7.3.2, !dbg !111 ; [#uses=1 type=i16] [debug line = 16:21]
  %tmp20 = add i16 %tmp21, %tmp22, !dbg !111      ; [#uses=1 type=i16] [debug line = 16:21]
  %tmp24 = add i16 %tmp.7.3.5, %tmp.7.3.4, !dbg !111 ; [#uses=1 type=i16] [debug line = 16:21]
  %tmp26 = add i16 %tmp.7.4.2, %tmp.7.4.1, !dbg !111 ; [#uses=1 type=i16] [debug line = 16:21]
  %tmp25 = add i16 %tmp.7.4, %tmp26, !dbg !111    ; [#uses=1 type=i16] [debug line = 16:21]
  %tmp23 = add i16 %tmp24, %tmp25, !dbg !111      ; [#uses=1 type=i16] [debug line = 16:21]
  %tmp19 = add i16 %tmp20, %tmp23, !dbg !111      ; [#uses=1 type=i16] [debug line = 16:21]
  %tmp29 = add i16 %tmp.7.4.4, %tmp.7.4.3, !dbg !111 ; [#uses=1 type=i16] [debug line = 16:21]
  %tmp30 = add i16 %tmp.7.5, %tmp.7.4.5, !dbg !111 ; [#uses=1 type=i16] [debug line = 16:21]
  %tmp28 = add i16 %tmp29, %tmp30, !dbg !111      ; [#uses=1 type=i16] [debug line = 16:21]
  %tmp32 = add i16 %tmp.7.5.2, %tmp.7.5.1, !dbg !111 ; [#uses=1 type=i16] [debug line = 16:21]
  %tmp34 = add i16 %tmp.7.5.5, %tmp.7.5.4, !dbg !111 ; [#uses=1 type=i16] [debug line = 16:21]
  %tmp33 = add i16 %tmp.7.5.3, %tmp34, !dbg !111  ; [#uses=1 type=i16] [debug line = 16:21]
  %tmp31 = add i16 %tmp32, %tmp33, !dbg !111      ; [#uses=1 type=i16] [debug line = 16:21]
  %tmp27 = add i16 %tmp28, %tmp31, !dbg !111      ; [#uses=1 type=i16] [debug line = 16:21]
  %tmp18 = add i16 %tmp19, %tmp27, !dbg !111      ; [#uses=1 type=i16] [debug line = 16:21]
  %tmp.10.5.5 = add i16 %tmp1, %tmp18, !dbg !111  ; [#uses=1 type=i16] [debug line = 16:21]
  ...
  call void @llvm.dbg.value(metadata !{i3 %j.1}, i64 0, metadata !120), !dbg !122 ; [debug line = 11:41] [debug variable = j]
...
; <label>:8                                       ; preds = %4
  ...
  call void @llvm.dbg.value(metadata !{i3 %i.1}, i64 0, metadata !124), !dbg !125 ; [debug line = 9:39] [debug variable = i]
  br label %1, !dbg !125                          ; [debug line = 9:39]
...
!124 = metadata !{i32 786688, metadata !104, metadata !"i", metadata !6, i32 9, metadata !121, i32 0, i32 0} ; [ DW_TAG_auto_variable ]
!125 = metadata !{i32 9, i32 39, metadata !104, null}
