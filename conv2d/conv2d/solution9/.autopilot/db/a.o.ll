...
define void @_Z6conv2dPA5_cPA3_cPA3_s([5 x i8]* %a, [3 x i8]* %b, [3 x i16]* %res) nounwind uwtable {
  ...
  br label %8, !dbg !43                           ; [debug line = 8:1]
...
; <label>:8                                       ; preds = %0
  ...
  br label %9, !dbg !47                           ; [debug line = 9:23]

; <label>:9                                       ; preds = %89, %8
  %10 = load i16* %i, align 2, !dbg !47           ; [#uses=1 type=i16] [debug line = 9:23]
  %11 = sext i16 %10 to i32, !dbg !47             ; [#uses=1 type=i32] [debug line = 9:23]
  %12 = icmp slt i32 %11, 3, !dbg !47             ; [#uses=1 type=i1] [debug line = 9:23]
  br i1 %12, label %13, label %92, !dbg !47       ; [debug line = 9:23]
...
; <label>:13                                      ; preds = %9
  ...
  br label %14, !dbg !48                          ; [debug line = 9:46]
...
; <label>:14                                      ; preds = %13
  ...
  br label %15, !dbg !53                          ; [debug line = 11:25]

; <label>:15                                      ; preds = %85, %14
  %16 = load i16* %j, align 2, !dbg !53           ; [#uses=1 type=i16] [debug line = 11:25]
  %17 = sext i16 %16 to i32, !dbg !53             ; [#uses=1 type=i32] [debug line = 11:25]
  %18 = icmp slt i32 %17, 3, !dbg !53             ; [#uses=1 type=i1] [debug line = 11:25]
  br i1 %18, label %19, label %88, !dbg !53       ; [debug line = 11:25]
...
; <label>:19                                      ; preds = %15
  ...
  %20 = load i16* %j, align 2, !dbg !57           ; [#uses=1 type=i16] [debug line = 13:7]
  %21 = sext i16 %20 to i64, !dbg !57             ; [#uses=1 type=i64] [debug line = 13:7]
  %22 = load i16* %i, align 2, !dbg !57           ; [#uses=1 type=i16] [debug line = 13:7]
  %23 = sext i16 %22 to i64, !dbg !57             ; [#uses=1 type=i64] [debug line = 13:7]
  %24 = load [3 x i16]** %3, align 8, !dbg !57    ; [#uses=1 type=[3 x i16]*] [debug line = 13:7]
  %25 = getelementptr inbounds [3 x i16]* %24, i64 %23, !dbg !57 ; [#uses=1 type=[3 x i16]*] [debug line = 13:7]
  %26 = getelementptr inbounds [3 x i16]* %25, i32 0, i64 %21, !dbg !57 ; [#uses=1 type=i16*] [debug line = 13:7]
  store i16 0, i16* %26, align 2, !dbg !57        ; [debug line = 13:7]
  br label %27, !dbg !57                          ; [debug line = 13:7]
...
; <label>:27                                      ; preds = %19
  ...
  br label %28, !dbg !61                          ; [debug line = 14:32]

; <label>:28                                      ; preds = %81, %27
  %29 = load i16* %ki, align 2, !dbg !61          ; [#uses=1 type=i16] [debug line = 14:32]
  %30 = sext i16 %29 to i32, !dbg !61             ; [#uses=1 type=i32] [debug line = 14:32]
  %31 = icmp slt i32 %30, 3, !dbg !61             ; [#uses=1 type=i1] [debug line = 14:32]
  br i1 %31, label %32, label %84, !dbg !61       ; [debug line = 14:32]
...
; <label>:32                                      ; preds = %28
  ...
  br label %33, !dbg !62                          ; [debug line = 14:49]
...
; <label>:33                                      ; preds = %32
  ...
  br label %34, !dbg !67                          ; [debug line = 15:45]

; <label>:34                                      ; preds = %77, %33
  %35 = load i16* %kj, align 2, !dbg !67          ; [#uses=1 type=i16] [debug line = 15:45]
  %36 = sext i16 %35 to i32, !dbg !67             ; [#uses=1 type=i32] [debug line = 15:45]
  %37 = icmp slt i32 %36, 3, !dbg !67             ; [#uses=1 type=i1] [debug line = 15:45]
  br i1 %37, label %38, label %80, !dbg !67       ; [debug line = 15:45]
...
; <label>:38                                      ; preds = %34
  ...
  %39 = load i16* %j, align 2, !dbg !70           ; [#uses=1 type=i16] [debug line = 16:21]
  %40 = sext i16 %39 to i32, !dbg !70             ; [#uses=1 type=i32] [debug line = 16:21]
  %41 = load i16* %kj, align 2, !dbg !70          ; [#uses=1 type=i16] [debug line = 16:21]
  %42 = sext i16 %41 to i32, !dbg !70             ; [#uses=1 type=i32] [debug line = 16:21]
  %43 = add nsw i32 %40, %42, !dbg !70            ; [#uses=1 type=i32] [debug line = 16:21]
  %44 = sext i32 %43 to i64, !dbg !70             ; [#uses=1 type=i64] [debug line = 16:21]
  %45 = load i16* %i, align 2, !dbg !70           ; [#uses=1 type=i16] [debug line = 16:21]
  %46 = sext i16 %45 to i32, !dbg !70             ; [#uses=1 type=i32] [debug line = 16:21]
  %47 = load i16* %ki, align 2, !dbg !70          ; [#uses=1 type=i16] [debug line = 16:21]
  %48 = sext i16 %47 to i32, !dbg !70             ; [#uses=1 type=i32] [debug line = 16:21]
  %49 = add nsw i32 %46, %48, !dbg !70            ; [#uses=1 type=i32] [debug line = 16:21]
  %50 = sext i32 %49 to i64, !dbg !70             ; [#uses=1 type=i64] [debug line = 16:21]
  %51 = load [5 x i8]** %1, align 8, !dbg !70     ; [#uses=1 type=[5 x i8]*] [debug line = 16:21]
  %52 = getelementptr inbounds [5 x i8]* %51, i64 %50, !dbg !70 ; [#uses=1 type=[5 x i8]*] [debug line = 16:21]
  %53 = getelementptr inbounds [5 x i8]* %52, i32 0, i64 %44, !dbg !70 ; [#uses=1 type=i8*] [debug line = 16:21]
  %54 = load i8* %53, align 1, !dbg !70           ; [#uses=1 type=i8] [debug line = 16:21]
  %55 = sext i8 %54 to i32, !dbg !70              ; [#uses=1 type=i32] [debug line = 16:21]
  %56 = load i16* %kj, align 2, !dbg !70          ; [#uses=1 type=i16] [debug line = 16:21]
  %57 = sext i16 %56 to i64, !dbg !70             ; [#uses=1 type=i64] [debug line = 16:21]
  %58 = load i16* %ki, align 2, !dbg !70          ; [#uses=1 type=i16] [debug line = 16:21]
  %59 = sext i16 %58 to i64, !dbg !70             ; [#uses=1 type=i64] [debug line = 16:21]
  %60 = load [3 x i8]** %2, align 8, !dbg !70     ; [#uses=1 type=[3 x i8]*] [debug line = 16:21]
  %61 = getelementptr inbounds [3 x i8]* %60, i64 %59, !dbg !70 ; [#uses=1 type=[3 x i8]*] [debug line = 16:21]
  %62 = getelementptr inbounds [3 x i8]* %61, i32 0, i64 %57, !dbg !70 ; [#uses=1 type=i8*] [debug line = 16:21]
  %63 = load i8* %62, align 1, !dbg !70           ; [#uses=1 type=i8] [debug line = 16:21]
  %64 = sext i8 %63 to i32, !dbg !70              ; [#uses=1 type=i32] [debug line = 16:21]
  %65 = mul nsw i32 %55, %64, !dbg !70            ; [#uses=1 type=i32] [debug line = 16:21]
  %66 = load i16* %j, align 2, !dbg !70           ; [#uses=1 type=i16] [debug line = 16:21]
  %67 = sext i16 %66 to i64, !dbg !70             ; [#uses=1 type=i64] [debug line = 16:21]
  %68 = load i16* %i, align 2, !dbg !70           ; [#uses=1 type=i16] [debug line = 16:21]
  %69 = sext i16 %68 to i64, !dbg !70             ; [#uses=1 type=i64] [debug line = 16:21]
  %70 = load [3 x i16]** %3, align 8, !dbg !70    ; [#uses=1 type=[3 x i16]*] [debug line = 16:21]
  %71 = getelementptr inbounds [3 x i16]* %70, i64 %69, !dbg !70 ; [#uses=1 type=[3 x i16]*] [debug line = 16:21]
  %72 = getelementptr inbounds [3 x i16]* %71, i32 0, i64 %67, !dbg !70 ; [#uses=2 type=i16*] [debug line = 16:21]
  %73 = load i16* %72, align 2, !dbg !70          ; [#uses=1 type=i16] [debug line = 16:21]
  %74 = sext i16 %73 to i32, !dbg !70             ; [#uses=1 type=i32] [debug line = 16:21]
  %75 = add nsw i32 %74, %65, !dbg !70            ; [#uses=1 type=i32] [debug line = 16:21]
  %76 = trunc i32 %75 to i16, !dbg !70            ; [#uses=1 type=i16] [debug line = 16:21]
  store i16 %76, i16* %72, align 2, !dbg !70      ; [debug line = 16:21]
  call void (...)* @_ssdm_RegionEnd(i8* getelementptr inbounds ([9 x i8]* @.str5, i32 0, i32 0)) nounwind, !dbg !71 ; [debug line = 17:9]
  br label %77, !dbg !71                          ; [debug line = 17:9]

; <label>:77                                      ; preds = %38
  %78 = load i16* %kj, align 2, !dbg !72          ; [#uses=1 type=i16] [debug line = 15:55]
  %79 = add i16 %78, 1, !dbg !72                  ; [#uses=1 type=i16] [debug line = 15:55]
  store i16 %79, i16* %kj, align 2, !dbg !72      ; [debug line = 15:55]
  br label %34, !dbg !72                          ; [debug line = 15:55]

; <label>:80                                      ; preds = %34
  call void (...)* @_ssdm_RegionEnd(i8* getelementptr inbounds ([8 x i8]* @.str4, i32 0, i32 0)) nounwind, !dbg !73 ; [debug line = 18:7]
  br label %81, !dbg !73                          ; [debug line = 18:7]

; <label>:81                                      ; preds = %80
  %82 = load i16* %ki, align 2, !dbg !74          ; [#uses=1 type=i16] [debug line = 14:42]
  %83 = add i16 %82, 1, !dbg !74                  ; [#uses=1 type=i16] [debug line = 14:42]
  store i16 %83, i16* %ki, align 2, !dbg !74      ; [debug line = 14:42]
  br label %28, !dbg !74                          ; [debug line = 14:42]

; <label>:84                                      ; preds = %28
  call void (...)* @_ssdm_RegionEnd(i8* getelementptr inbounds ([4 x i8]* @.str3, i32 0, i32 0)) nounwind, !dbg !75 ; [debug line = 19:5]
  br label %85, !dbg !75                          ; [debug line = 19:5]

; <label>:85                                      ; preds = %84
  %86 = load i16* %j, align 2, !dbg !76           ; [#uses=1 type=i16] [debug line = 11:42]
  %87 = add i16 %86, 1, !dbg !76                  ; [#uses=1 type=i16] [debug line = 11:42]
  store i16 %87, i16* %j, align 2, !dbg !76       ; [debug line = 11:42]
  br label %15, !dbg !76                          ; [debug line = 11:42]

; <label>:88                                      ; preds = %15
  call void (...)* @_ssdm_RegionEnd(i8* getelementptr inbounds ([4 x i8]* @.str2, i32 0, i32 0)) nounwind, !dbg !77 ; [debug line = 20:3]
  br label %89, !dbg !77                          ; [debug line = 20:3]

; <label>:89                                      ; preds = %88
  %90 = load i16* %i, align 2, !dbg !78           ; [#uses=1 type=i16] [debug line = 9:40]
  %91 = add i16 %90, 1, !dbg !78                  ; [#uses=1 type=i16] [debug line = 9:40]
  store i16 %91, i16* %i, align 2, !dbg !78       ; [debug line = 9:40]
  br label %9, !dbg !78                           ; [debug line = 9:40]
