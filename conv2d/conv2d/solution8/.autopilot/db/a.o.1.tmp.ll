; ModuleID = 'E:/vivado/conv2d/conv2d/solution8/.autopilot/db/a.o.1.tmp.bc'
...
; <label>:1                                       ; preds = %3, %0
  ...
  %exitcond3 = icmp eq i16 %i, 3, !dbg !78        ; [#uses=1 type=i1] [debug line = 11:23]
...
; <label>:3                                       ; preds = %1
  ...
  %tmp = zext i16 %i to i64, !dbg !84             ; [#uses=8 type=i64] [debug line = 15:7]
  %tmp.1 = zext i16 %i to i32, !dbg !87           ; [#uses=2 type=i32] [debug line = 18:21]
  ...
  %tmp.10.0 = sext i8 %a.load to i16, !dbg !87    ; [#uses=1 type=i16] [debug line = 18:21]
  %"b[0].load" = load i8* %"b[0].addr", align 1, !dbg !87 ; [#uses=1 type=i8] [debug line = 18:21]
  %tmp.12.0 = sext i8 %"b[0].load" to i16, !dbg !87 ; [#uses=3 type=i16] [debug line = 18:21]
  %tmp.13.0 = mul i16 %tmp.12.0, %tmp.10.0, !dbg !87 ; [#uses=1 type=i16] [debug line = 18:21]
  ...
  %tmp.14.0.0.1 = add i16 %tmp.13.0, %tmp.13.0.0.1, !dbg !87 ; [#uses=1 type=i16] [debug line = 18:21]
  ...
  %tmp.14.0.0.2 = add i16 %tmp.14.0.0.1, %tmp.13.0.0.2, !dbg !87 ; [#uses=1 type=i16] [debug line = 18:21]
  %tmp.7.0.1 = add nsw i32 %tmp.1, 1, !dbg !87    ; [#uses=1 type=i32] [debug line = 18:21]
  %tmp.8.0.1 = zext i32 %tmp.7.0.1 to i64, !dbg !87 ; [#uses=5 type=i64] [debug line = 18:21]
  ...
  %tmp.14.0.1 = add i16 %tmp.14.0.0.2, %tmp.13.0.1, !dbg !87 ; [#uses=1 type=i16] [debug line = 18:21]
  ...
  %tmp.14.0.1.1 = add i16 %tmp.14.0.1, %tmp.13.0.1.1, !dbg !87 ; [#uses=1 type=i16] [debug line = 18:21]
  ...
  %tmp.14.0.1.2 = add i16 %tmp.14.0.1.1, %tmp.13.0.1.2, !dbg !87 ; [#uses=1 type=i16] [debug line = 18:21]
  %tmp.7.0.2 = add nsw i32 %tmp.1, 2, !dbg !87    ; [#uses=1 type=i32] [debug line = 18:21]
  %tmp.8.0.2 = zext i32 %tmp.7.0.2 to i64, !dbg !87 ; [#uses=5 type=i64] [debug line = 18:21]
  ...
  %tmp.14.0.2 = add i16 %tmp.14.0.1.2, %tmp.13.0.2, !dbg !87 ; [#uses=1 type=i16] [debug line = 18:21]
  ...
  %tmp.14.0.2.1 = add i16 %tmp.14.0.2, %tmp.13.0.2.1, !dbg !87 ; [#uses=1 type=i16] [debug line = 18:21]
  ...
  %tmp.14.0.2.2 = add i16 %tmp.14.0.2.1, %tmp.13.0.2.2, !dbg !87 ; [#uses=1 type=i16] [debug line = 18:21]
  ...
  %tmp.13.1 = mul i16 %tmp.12.0, %tmp.10.0.0.1, !dbg !87 ; [#uses=1 type=i16] [debug line = 18:21]
  %tmp.13.1.0.1 = mul i16 %tmp.12.0.0.1, %tmp.10.0.0.2, !dbg !87 ; [#uses=1 type=i16] [debug line = 18:21]
  %tmp.14.1.0.1 = add i16 %tmp.13.1, %tmp.13.1.0.1, !dbg !87 ; [#uses=1 type=i16] [debug line = 18:21]
  ...
  %tmp.14.1.0.2 = add i16 %tmp.14.1.0.1, %tmp.13.1.0.2, !dbg !87 ; [#uses=1 type=i16] [debug line = 18:21]
  %tmp.13.1.1 = mul i16 %tmp.12.0.1, %tmp.10.0.1.1, !dbg !87 ; [#uses=1 type=i16] [debug line = 18:21]
  %tmp.14.1.1 = add i16 %tmp.14.1.0.2, %tmp.13.1.1, !dbg !87 ; [#uses=1 type=i16] [debug line = 18:21]
  %tmp.13.1.1.1 = mul i16 %tmp.12.0.1.1, %tmp.10.0.1.2, !dbg !87 ; [#uses=1 type=i16] [debug line = 18:21]
  %tmp.14.1.1.1 = add i16 %tmp.14.1.1, %tmp.13.1.1.1, !dbg !87 ; [#uses=1 type=i16] [debug line = 18:21]
  ...
  %tmp.14.1.1.2 = add i16 %tmp.14.1.1.1, %tmp.13.1.1.2, !dbg !87 ; [#uses=1 type=i16] [debug line = 18:21]
  %tmp.13.1.2 = mul i16 %tmp.12.0.2, %tmp.10.0.2.1, !dbg !87 ; [#uses=1 type=i16] [debug line = 18:21]
  %tmp.14.1.2 = add i16 %tmp.14.1.1.2, %tmp.13.1.2, !dbg !87 ; [#uses=1 type=i16] [debug line = 18:21]
  %tmp.13.1.2.1 = mul i16 %tmp.12.0.2.1, %tmp.10.0.2.2, !dbg !87 ; [#uses=1 type=i16] [debug line = 18:21]
  %tmp.14.1.2.1 = add i16 %tmp.14.1.2, %tmp.13.1.2.1, !dbg !87 ; [#uses=1 type=i16] [debug line = 18:21]
  ...
  %tmp.14.1.2.2 = add i16 %tmp.14.1.2.1, %tmp.13.1.2.2, !dbg !87 ; [#uses=1 type=i16] [debug line = 18:21]
  ...
  %tmp.13.2 = mul i16 %tmp.12.0, %tmp.10.0.0.2, !dbg !87 ; [#uses=1 type=i16] [debug line = 18:21]
  %tmp.13.2.0.1 = mul i16 %tmp.12.0.0.1, %tmp.10.1.0.2, !dbg !87 ; [#uses=1 type=i16] [debug line = 18:21]
  %tmp.14.2.0.1 = add i16 %tmp.13.2, %tmp.13.2.0.1, !dbg !87 ; [#uses=1 type=i16] [debug line = 18:21]
  ...
  %tmp.14.2.0.2 = add i16 %tmp.14.2.0.1, %tmp.13.2.0.2, !dbg !87 ; [#uses=1 type=i16] [debug line = 18:21]
  %tmp.13.2.1 = mul i16 %tmp.12.0.1, %tmp.10.0.1.2, !dbg !87 ; [#uses=1 type=i16] [debug line = 18:21]
  %tmp.14.2.1 = add i16 %tmp.14.2.0.2, %tmp.13.2.1, !dbg !87 ; [#uses=1 type=i16] [debug line = 18:21]
  %tmp.13.2.1.1 = mul i16 %tmp.12.0.1.1, %tmp.10.1.1.2, !dbg !87 ; [#uses=1 type=i16] [debug line = 18:21]
  %tmp.14.2.1.1 = add i16 %tmp.14.2.1, %tmp.13.2.1.1, !dbg !87 ; [#uses=1 type=i16] [debug line = 18:21]
  ...
  %tmp.14.2.1.2 = add i16 %tmp.14.2.1.1, %tmp.13.2.1.2, !dbg !87 ; [#uses=1 type=i16] [debug line = 18:21]
  %tmp.13.2.2 = mul i16 %tmp.12.0.2, %tmp.10.0.2.2, !dbg !87 ; [#uses=1 type=i16] [debug line = 18:21]
  %tmp.14.2.2 = add i16 %tmp.14.2.1.2, %tmp.13.2.2, !dbg !87 ; [#uses=1 type=i16] [debug line = 18:21]
  %tmp.13.2.2.1 = mul i16 %tmp.12.0.2.1, %tmp.10.1.2.2, !dbg !87 ; [#uses=1 type=i16] [debug line = 18:21]
  %tmp.14.2.2.1 = add i16 %tmp.14.2.2, %tmp.13.2.2.1, !dbg !87 ; [#uses=1 type=i16] [debug line = 18:21]
  ...
  %tmp.14.2.2.2 = add i16 %tmp.14.2.2.1, %tmp.13.2.2.2, !dbg !87 ; [#uses=1 type=i16] [debug line = 18:21]
  ...
  %i.1 = add i16 %i, 1, !dbg !93                  ; [#uses=1 type=i16] [debug line = 11:42]
  call void @llvm.dbg.value(metadata !{i16 %i.1}, i64 0, metadata !94), !dbg !93 ; [debug line = 11:42] [debug variable = i]
