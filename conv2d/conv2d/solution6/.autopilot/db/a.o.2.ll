...
; <label>:1                                       ; preds = %17, %0
  %i = phi i2 [ 0, %0 ], [ %i.1, %17 ]            ; [#uses=5 type=i2]
  %exitcond3 = icmp eq i2 %i, -1, !dbg !106       ; [#uses=1 type=i1] [debug line = 9:23]
...
; <label>:3                                       ; preds = %1
  ...
  %tmp = zext i2 %i to i64, !dbg !111             ; [#uses=6 type=i64] [debug line = 13:7]
  %tmp.1.cast9 = zext i2 %i to i3, !dbg !114      ; [#uses=1 type=i3] [debug line = 16:21]
  ...
  %tmp.7.1 = add i2 %i, 1, !dbg !114              ; [#uses=1 type=i2] [debug line = 16:21]
  %tmp.8.1 = zext i2 %tmp.7.1 to i64, !dbg !114   ; [#uses=5 type=i64] [debug line = 16:21]
  ...
  %tmp.7.2 = add i3 %tmp.1.cast9, 2, !dbg !114    ; [#uses=1 type=i3] [debug line = 16:21]
  %tmp.8.2 = zext i3 %tmp.7.2 to i64, !dbg !114   ; [#uses=5 type=i64] [debug line = 16:21]
...
; <label>:4                                       ; preds = %15, %3
  %j = phi i2 [ 0, %3 ], [ %j.1, %15 ]            ; [#uses=12 type=i2]
  %exitcond2 = icmp eq i2 %j, -1, !dbg !119       ; [#uses=1 type=i1] [debug line = 11:25]
...
; <label>:7                                       ; preds = %branch42, %branch41, %branch40
  ...
  %tmp. = sext i8 %a.load.0.0.phi to i16, !dbg !114 ; [#uses=1 type=i16] [debug line = 16:21]
  %"b[0].load" = load i8* %"b[0].addr", align 1, !dbg !114 ; [#uses=1 type=i8] [debug line = 16:21]
  %tmp.1 = sext i8 %"b[0].load" to i16, !dbg !114 ; [#uses=1 type=i16] [debug line = 16:21]
  %tmp.4 = mul i16 %tmp., %tmp.1, !dbg !114       ; [#uses=1 type=i16] [debug line = 16:21]
  switch i2 %j, label %branch38 [
    i2 0, label %branch36
    i2 1, label %branch37
  ], !dbg !114                                    ; [debug line = 16:21]
...
; <label>:15                                      ; preds = %branch4, %branch3, %branch2
  ...
  %tmp2 = add i16 %tmp.13.0.1, %tmp.4, !dbg !114  ; [#uses=1 type=i16] [debug line = 16:21]
  %tmp3 = add i16 %tmp.13.1, %tmp.13.0.2, !dbg !114 ; [#uses=1 type=i16] [debug line = 16:21]
  %tmp1 = add i16 %tmp2, %tmp3, !dbg !114         ; [#uses=1 type=i16] [debug line = 16:21]
  %tmp5 = add i16 %tmp.13.1.2, %tmp.13.1.1, !dbg !114 ; [#uses=1 type=i16] [debug line = 16:21]
  %tmp7 = add i16 %tmp.13.2.2, %tmp.13.2.1, !dbg !114 ; [#uses=1 type=i16] [debug line = 16:21]
  %tmp6 = add i16 %tmp.13.2, %tmp7, !dbg !114     ; [#uses=1 type=i16] [debug line = 16:21]
  %tmp4 = add i16 %tmp5, %tmp6, !dbg !114         ; [#uses=1 type=i16] [debug line = 16:21]
  %tmp.14.2.2 = add i16 %tmp1, %tmp4, !dbg !114   ; [#uses=1 type=i16] [debug line = 16:21]
  ...
  %j.1 = add i2 %j, 1, !dbg !123                  ; [#uses=1 type=i2] [debug line = 11:42]
  call void @llvm.dbg.value(metadata !{i2 %j.1}, i64 0, metadata !124), !dbg !123 ; [debug line = 11:42] [debug variable = j]
...
; <label>:17                                      ; preds = %4
  ...
  %i.1 = add i2 %i, 1, !dbg !126                  ; [#uses=1 type=i2] [debug line = 9:40]
  call void @llvm.dbg.value(metadata !{i2 %i.1}, i64 0, metadata !127), !dbg !126 ; [debug line = 9:40] [debug variable = i]
