; ModuleID = 'E:/vivado/conv2d/conv2d/solution6/.autopilot/db/a.g.1.bc'
...
; <label>:4                                       ; preds = %3
  ...
  call void (...)* @_ssdm_op_SpecPipeline(i32 1, i32 1, i32 1, i32 0, i8* getelementptr inbounds ([1 x i8]* @.str1, i64 0, i64 0)) nounwind, !dbg !58 ; [debug line = 12:1]
