...
#ifndef __conv2d_mac_muladdcud__HH__
#define __conv2d_mac_muladdcud__HH__
...
template<
    ...
    int din2_WIDTH,
    int dout_WIDTH>
SC_MODULE(conv2d_mac_muladdcud) {
    ...
    SC_CTOR(conv2d_mac_muladdcud):  simcore_mac_0_U ("simcore_mac_0_U") {
