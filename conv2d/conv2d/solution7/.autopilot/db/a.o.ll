; ModuleID = 'E:/vivado/conv2d/conv2d/solution7/.autopilot/db/a.o.bc'
...
define void @_Z6conv2dPA5_cPA3_cPA3_s([5 x i8]* %a, [3 x i8]* %b, [3 x i16]* %res) nounwind uwtable {
  ...
  call void (...)* @_ssdm_SpecArrayPartition([3 x i8]* %7, i32 0, i8* getelementptr inbounds ([9 x i8]* @.str, i32 0, i32 0), i32 0, i8* getelementptr inbounds ([1 x i8]* @.str1, i32 0, i32 0)) nounwind, !dbg !43 ; [debug line = 8:1]
  %8 = load [5 x i8]** %1, align 8, !dbg !43      ; [#uses=1 type=[5 x i8]*] [debug line = 8:1]
  call void (...)* @_ssdm_SpecArrayPartition([5 x i8]* %8, i32 0, i8* getelementptr inbounds ([9 x i8]* @.str, i32 0, i32 0), i32 0, i8* getelementptr inbounds ([1 x i8]* @.str1, i32 0, i32 0)) nounwind, !dbg !43 ; [debug line = 8:1]
...
; <label>:20                                      ; preds = %16
  ...
  call void (...)* @_ssdm_op_SpecPipeline(i32 0, i32 0, i32 0, i32 1, i8* getelementptr inbounds ([1 x i8]* @.str1, i32 0, i32 0)) nounwind, !dbg !56 ; [debug line = 12:1]
