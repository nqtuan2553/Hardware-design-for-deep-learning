...
`define AUTOTB_DUT      conv2d
`define AUTOTB_DUT_INST AESL_inst_conv2d
`define AUTOTB_TOP      apatb_conv2d_top
`define AUTOTB_LAT_RESULT_FILE "conv2d.result.lat.rb"
`define AUTOTB_PER_RESULT_TRANS_FILE "conv2d.performance.result.transaction.xml"
`define AUTOTB_TOP_INST AESL_inst_apatb_conv2d_top
...
`define AUTOTB_TVIN_a  "./c.conv2d.autotvin_a.dat"
`define AUTOTB_TVIN_b  "./c.conv2d.autotvin_b.dat"
`define AUTOTB_TVIN_res  "./c.conv2d.autotvin_res.dat"
`define AUTOTB_TVIN_a_out_wrapc  "./rtl.conv2d.autotvin_a.dat"
`define AUTOTB_TVIN_b_out_wrapc  "./rtl.conv2d.autotvin_b.dat"
`define AUTOTB_TVIN_res_out_wrapc  "./rtl.conv2d.autotvin_res.dat"
`define AUTOTB_TVOUT_res  "./c.conv2d.autotvout_res.dat"
`define AUTOTB_TVOUT_res_out_wrapc  "./impl_rtl.conv2d.autotvout_res.dat"
module `AUTOTB_TOP;
...
initial begin : generate_AESL_ready_cnt_proc
    ...
    initial begin : finish_simulation
        ...
        @ (posedge AESL_clock);
        @ (posedge AESL_clock);
    fp1 = $fopen("./rtl.conv2d.autotvout_res.dat", "r");
    fp2 = $fopen("./impl_rtl.conv2d.autotvout_res.dat", "r");
    if(fp1 == 0)        // Failed to open file
        $display("Failed to open file \"./rtl.conv2d.autotvout_res.dat\"!");
    else if(fp2 == 0)
        $display("Failed to open file \"./impl_rtl.conv2d.autotvout_res.dat\"!");
    else begin
        $display("Comparing rtl.conv2d.autotvout_res.dat with impl_rtl.conv2d.autotvout_res.dat");
        post_check(fp1, fp2);
    end
    $fclose(fp1);
    $fclose(fp2);
