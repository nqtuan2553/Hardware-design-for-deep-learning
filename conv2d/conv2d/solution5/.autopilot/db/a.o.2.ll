...
; <label>:1                                       ; preds = %58, %0
  %i = phi i2 [ 0, %0 ], [ %i.1, %58 ]            ; [#uses=57 type=i2]
  %exitcond3 = icmp eq i2 %i, -1, !dbg !128       ; [#uses=1 type=i1] [debug line = 11:21]
...
; <label>:5                                       ; preds = %branch132, %branch131, %branch130
  ...
  %tmp. = sext i8 %a.load.0.0.0.phi to i16, !dbg !123 ; [#uses=1 type=i16] [debug line = 18:21]
  %"b[0].load" = load i8* %"b[0].addr", align 1, !dbg !123 ; [#uses=1 type=i8] [debug line = 18:21]
  %tmp.3 = sext i8 %"b[0].load" to i16, !dbg !123 ; [#uses=3 type=i16] [debug line = 18:21]
  %tmp.7 = mul i16 %tmp.3, %tmp., !dbg !123       ; [#uses=4 type=i16] [debug line = 18:21]
...
; <label>:7                                       ; preds = %branch127, %branch126, %branch125
  ...
  %tmp.10.0.0.1 = add i16 %tmp.7, %tmp.7.0.0.1, !dbg !123 ; [#uses=4 type=i16] [debug line = 18:21]
...
; <label>:10                                      ; preds = %branch80, %branch79, %branch78
  %i.1 = add i2 %i, 1, !dbg !123                  ; [#uses=1 type=i2] [debug line = 18:21]
...
; <label>:23                                      ; preds = %branch122, %branch121, %branch120
  ...
  %tmp.7.1 = mul i16 %tmp.3, %tmp..1, !dbg !123   ; [#uses=4 type=i16] [debug line = 18:21]
...
; <label>:41                                      ; preds = %branch107, %branch106, %branch105
  ...
  %tmp.7.2 = mul i16 %tmp.3, %tmp..2, !dbg !123   ; [#uses=4 type=i16] [debug line = 18:21]
...
; <label>:58                                      ; preds = %branch2, %branch1, %branch0
  ...
  call void @llvm.dbg.value(metadata !{i2 %i.1}, i64 0, metadata !132), !dbg !134 ; [debug line = 11:40] [debug variable = i]
...
branch84:                                         ; preds = %5
  store i16 %tmp.7, i16* %"res[0].addr", align 2, !dbg !123 ; [debug line = 18:21]
  br label %6, !dbg !123                          ; [debug line = 18:21]

branch85:                                         ; preds = %5
  store i16 %tmp.7, i16* %"res[1].addr", align 2, !dbg !123 ; [debug line = 18:21]
  br label %6, !dbg !123                          ; [debug line = 18:21]

branch86:                                         ; preds = %5
  store i16 %tmp.7, i16* %"res[2].addr", align 2, !dbg !123 ; [debug line = 18:21]
  br label %6, !dbg !123                          ; [debug line = 18:21]
