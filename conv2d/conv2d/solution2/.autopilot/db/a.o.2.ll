...
; <label>:1                                       ; preds = %20, %0
  %i = phi i2 [ 0, %0 ], [ %i.1, %20 ]            ; [#uses=4 type=i2]
  %exitcond3 = icmp eq i2 %i, -1, !dbg !117       ; [#uses=1 type=i1] [debug line = 9:23]
...
; <label>:3                                       ; preds = %1
  ...
  %tmp = zext i2 %i to i64, !dbg !122             ; [#uses=3 type=i64] [debug line = 13:7]
  %tmp.1.cast = zext i2 %i to i3, !dbg !122       ; [#uses=1 type=i3] [debug line = 13:7]
  %"res[0].addr" = getelementptr [3 x i16]* %"res[0]", i64 0, i64 %tmp, !dbg !122 ; [#uses=5 type=i16*] [debug line = 13:7]
  %"res[1].addr" = getelementptr [3 x i16]* %"res[1]", i64 0, i64 %tmp, !dbg !122 ; [#uses=5 type=i16*] [debug line = 13:7]
  %"res[2].addr" = getelementptr [3 x i16]* %"res[2]", i64 0, i64 %tmp, !dbg !122 ; [#uses=5 type=i16*] [debug line = 13:7]
  br label %4, !dbg !125                          ; [debug line = 11:25]

; <label>:4                                       ; preds = %18, %3
  %j = phi i2 [ 0, %3 ], [ %j.1, %18 ]            ; [#uses=10 type=i2]
  %exitcond2 = icmp eq i2 %j, -1, !dbg !125       ; [#uses=1 type=i1] [debug line = 11:25]
  %5 = call i32 (...)* @_ssdm_op_SpecLoopTripCount(i64 3, i64 3, i64 3) nounwind ; [#uses=0 type=i32]
  br i1 %exitcond2, label %20, label %6, !dbg !125 ; [debug line = 11:25]

; <label>:6                                       ; preds = %4
  call void (...)* @_ssdm_op_SpecLoopName([4 x i8]* @.str3) nounwind, !dbg !126 ; [debug line = 11:48]
  %tmp.3 = call i32 (...)* @_ssdm_op_SpecRegionBegin([4 x i8]* @.str3) nounwind, !dbg !126 ; [#uses=1 type=i32] [debug line = 11:48]
...
; <label>:7                                       ; preds = %branch11, %branch10, %branch9
  br label %8, !dbg !127                          ; [debug line = 14:32]

; <label>:8                                       ; preds = %16, %7
  %ki = phi i2 [ 0, %7 ], [ %ki.1, %16 ]          ; [#uses=4 type=i2]
  %exitcond1 = icmp eq i2 %ki, -1, !dbg !127      ; [#uses=1 type=i1] [debug line = 14:32]
  %9 = call i32 (...)* @_ssdm_op_SpecLoopTripCount(i64 3, i64 3, i64 3) nounwind ; [#uses=0 type=i32]
  br i1 %exitcond1, label %18, label %10, !dbg !127 ; [debug line = 14:32]

; <label>:10                                      ; preds = %8
  call void (...)* @_ssdm_op_SpecLoopName([8 x i8]* @.str4) nounwind, !dbg !129 ; [debug line = 14:49]
  %tmp.4 = call i32 (...)* @_ssdm_op_SpecRegionBegin([8 x i8]* @.str4) nounwind, !dbg !129 ; [#uses=1 type=i32] [debug line = 14:49]
  call void (...)* @_ssdm_op_SpecPipeline(i32 1, i32 1, i32 1, i32 0, [1 x i8]* @.str1) nounwind, !dbg !131 ; [debug line = 15:1]
  %tmp.6.cast = zext i2 %ki to i3, !dbg !132      ; [#uses=1 type=i3] [debug line = 16:21]
  %tmp.7 = add i3 %tmp.6.cast, %tmp.1.cast, !dbg !132 ; [#uses=1 type=i3] [debug line = 16:21]
  %tmp.8 = zext i3 %tmp.7 to i64, !dbg !132       ; [#uses=5 type=i64] [debug line = 16:21]
  %tmp.9 = zext i2 %ki to i64, !dbg !132          ; [#uses=3 type=i64] [debug line = 16:21]
  %"a[0].addr" = getelementptr [5 x i8]* %"a[0]", i64 0, i64 %tmp.8, !dbg !132 ; [#uses=1 type=i8*] [debug line = 16:21]
  %"a[1].addr" = getelementptr [5 x i8]* %"a[1]", i64 0, i64 %tmp.8, !dbg !132 ; [#uses=2 type=i8*] [debug line = 16:21]
  %"a[2].addr" = getelementptr [5 x i8]* %"a[2]", i64 0, i64 %tmp.8, !dbg !132 ; [#uses=3 type=i8*] [debug line = 16:21]
  switch i2 %j, label %branch12 [
    i2 0, label %branch1051
    i2 1, label %branch1153
  ], !dbg !132                                    ; [debug line = 16:21]

; <label>:11                                      ; preds = %branch12, %branch1153, %branch1051
  %a.load.0.phi = phi i8 [ %"a[0].load", %branch1051 ], [ %"a[1].load", %branch1153 ], [ %"a[2].load", %branch12 ], !dbg !132 ; [#uses=1 type=i8] [debug line = 16:21]
  %tmp. = sext i8 %a.load.0.phi to i16, !dbg !132 ; [#uses=1 type=i16] [debug line = 16:21]
  %"b[0].addr" = getelementptr [3 x i8]* %"b[0]", i64 0, i64 %tmp.9 ; [#uses=1 type=i8*]
  %"b[0].load" = load i8* %"b[0].addr", align 1, !dbg !132 ; [#uses=1 type=i8] [debug line = 16:21]
  %tmp.1 = sext i8 %"b[0].load" to i16, !dbg !132 ; [#uses=1 type=i16] [debug line = 16:21]
  %tmp.5 = mul i16 %tmp.1, %tmp., !dbg !132       ; [#uses=1 type=i16] [debug line = 16:21]
  %"res[0].load" = load i16* %"res[0].addr", align 2 ; [#uses=1 type=i16]
  %"res[1].load" = load i16* %"res[1].addr", align 2 ; [#uses=1 type=i16]
  %"res[2].load" = load i16* %"res[2].addr", align 2 ; [#uses=1 type=i16]
  %tmp.6 = call i16 @_ssdm_op_Mux.ap_auto.3i16.i2(i16 %"res[0].load", i16 %"res[1].load", i16 %"res[2].load", i2 %j) ; [#uses=1 type=i16]
  %tmp.10 = add i16 %tmp.6, %tmp.5, !dbg !132     ; [#uses=4 type=i16] [debug line = 16:21]
...
; <label>:12                                      ; preds = %branch8, %branch7, %branch6
  %"a[3].addr" = getelementptr [5 x i8]* %"a[3]", i64 0, i64 %tmp.8, !dbg !132 ; [#uses=2 type=i8*] [debug line = 16:21]
  switch i2 %j, label %branch841 [
    i2 0, label %branch637
    i2 1, label %branch739
  ], !dbg !132                                    ; [debug line = 16:21]

; <label>:13                                      ; preds = %branch841, %branch739, %branch637
  %a.load.1.phi = phi i8 [ %"a[1].load.1", %branch637 ], [ %"a[2].load.1", %branch739 ], [ %"a[3].load", %branch841 ], !dbg !132 ; [#uses=1 type=i8] [debug line = 16:21]
  %tmp.10.1 = sext i8 %a.load.1.phi to i16, !dbg !132 ; [#uses=1 type=i16] [debug line = 16:21]
  %"b[1].addr" = getelementptr [3 x i8]* %"b[1]", i64 0, i64 %tmp.9 ; [#uses=1 type=i8*]
  %"b[1].load" = load i8* %"b[1].addr", align 1, !dbg !132 ; [#uses=1 type=i8] [debug line = 16:21]
  %tmp.12.1 = sext i8 %"b[1].load" to i16, !dbg !132 ; [#uses=1 type=i16] [debug line = 16:21]
  %tmp.13.1 = mul i16 %tmp.12.1, %tmp.10.1, !dbg !132 ; [#uses=1 type=i16] [debug line = 16:21]
  %tmp.14.1 = add i16 %tmp.10, %tmp.13.1, !dbg !132 ; [#uses=4 type=i16] [debug line = 16:21]
...
; <label>:14                                      ; preds = %branch5, %branch4, %branch3
  %"a[4].addr" = getelementptr [5 x i8]* %"a[4]", i64 0, i64 %tmp.8, !dbg !132 ; [#uses=1 type=i8*] [debug line = 16:21]
  switch i2 %j, label %branch428 [
    i2 0, label %branch224
    i2 1, label %branch326
  ], !dbg !132                                    ; [debug line = 16:21]

; <label>:15                                      ; preds = %branch428, %branch326, %branch224
  %a.load.2.phi = phi i8 [ %"a[2].load.2", %branch224 ], [ %"a[3].load.1", %branch326 ], [ %"a[4].load", %branch428 ], !dbg !132 ; [#uses=1 type=i8] [debug line = 16:21]
  %tmp.10.2 = sext i8 %a.load.2.phi to i16, !dbg !132 ; [#uses=1 type=i16] [debug line = 16:21]
  %"b[2].addr" = getelementptr [3 x i8]* %"b[2]", i64 0, i64 %tmp.9 ; [#uses=1 type=i8*]
  %"b[2].load" = load i8* %"b[2].addr", align 1, !dbg !132 ; [#uses=1 type=i8] [debug line = 16:21]
  %tmp.12.2 = sext i8 %"b[2].load" to i16, !dbg !132 ; [#uses=1 type=i16] [debug line = 16:21]
  %tmp.13.2 = mul i16 %tmp.12.2, %tmp.10.2, !dbg !132 ; [#uses=1 type=i16] [debug line = 16:21]
  %tmp.14.2 = add i16 %tmp.14.1, %tmp.13.2, !dbg !132 ; [#uses=3 type=i16] [debug line = 16:21]
  switch i2 %j, label %branch2 [
    i2 0, label %branch0
    i2 1, label %branch1
  ], !dbg !132                                    ; [debug line = 16:21]
...
; <label>:16                                      ; preds = %branch2, %branch1, %branch0
  ...
  %ki.1 = add i2 %ki, 1, !dbg !136                ; [#uses=1 type=i2] [debug line = 14:42]
  call void @llvm.dbg.value(metadata !{i2 %ki.1}, i64 0, metadata !137), !dbg !136 ; [debug line = 14:42] [debug variable = ki]
...
; <label>:18                                      ; preds = %8
  ...
  %j.1 = add i2 %j, 1, !dbg !139                  ; [#uses=1 type=i2] [debug line = 11:42]
  call void @llvm.dbg.value(metadata !{i2 %j.1}, i64 0, metadata !140), !dbg !139 ; [debug line = 11:42] [debug variable = j]
...
; <label>:20                                      ; preds = %4
  ...
  %i.1 = add i2 %i, 1, !dbg !142                  ; [#uses=1 type=i2] [debug line = 9:40]
  call void @llvm.dbg.value(metadata !{i2 %i.1}, i64 0, metadata !143), !dbg !142 ; [debug line = 9:40] [debug variable = i]
...
branch0:                                          ; preds = %15
  store i16 %tmp.14.2, i16* %"res[0].addr", align 2, !dbg !132 ; [debug line = 16:21]
  br label %16, !dbg !132                         ; [debug line = 16:21]

branch1:                                          ; preds = %15
  store i16 %tmp.14.2, i16* %"res[1].addr", align 2, !dbg !132 ; [debug line = 16:21]
  br label %16, !dbg !132                         ; [debug line = 16:21]

branch2:                                          ; preds = %15
  store i16 %tmp.14.2, i16* %"res[2].addr", align 2, !dbg !132 ; [debug line = 16:21]
  br label %16, !dbg !132                         ; [debug line = 16:21]

branch3:                                          ; preds = %13
  store i16 %tmp.14.1, i16* %"res[0].addr", align 2, !dbg !132 ; [debug line = 16:21]
  br label %14, !dbg !132                         ; [debug line = 16:21]

branch4:                                          ; preds = %13
  store i16 %tmp.14.1, i16* %"res[1].addr", align 2, !dbg !132 ; [debug line = 16:21]
  br label %14, !dbg !132                         ; [debug line = 16:21]

branch5:                                          ; preds = %13
  store i16 %tmp.14.1, i16* %"res[2].addr", align 2, !dbg !132 ; [debug line = 16:21]
  br label %14, !dbg !132                         ; [debug line = 16:21]

branch6:                                          ; preds = %11
  store i16 %tmp.10, i16* %"res[0].addr", align 2, !dbg !132 ; [debug line = 16:21]
  br label %12, !dbg !132                         ; [debug line = 16:21]

branch7:                                          ; preds = %11
  store i16 %tmp.10, i16* %"res[1].addr", align 2, !dbg !132 ; [debug line = 16:21]
  br label %12, !dbg !132                         ; [debug line = 16:21]

branch8:                                          ; preds = %11
  store i16 %tmp.10, i16* %"res[2].addr", align 2, !dbg !132 ; [debug line = 16:21]
  br label %12, !dbg !132                         ; [debug line = 16:21]
...
branch224:                                        ; preds = %14
  %"a[2].load.2" = load i8* %"a[2].addr", align 1, !dbg !132 ; [#uses=1 type=i8] [debug line = 16:21]
  br label %15, !dbg !132                         ; [debug line = 16:21]

branch326:                                        ; preds = %14
  %"a[3].load.1" = load i8* %"a[3].addr", align 1, !dbg !132 ; [#uses=1 type=i8] [debug line = 16:21]
  br label %15, !dbg !132                         ; [debug line = 16:21]

branch428:                                        ; preds = %14
  %"a[4].load" = load i8* %"a[4].addr", align 1, !dbg !132 ; [#uses=1 type=i8] [debug line = 16:21]
  br label %15, !dbg !132                         ; [debug line = 16:21]

branch637:                                        ; preds = %12
  %"a[1].load.1" = load i8* %"a[1].addr", align 1, !dbg !132 ; [#uses=1 type=i8] [debug line = 16:21]
  br label %13, !dbg !132                         ; [debug line = 16:21]

branch739:                                        ; preds = %12
  %"a[2].load.1" = load i8* %"a[2].addr", align 1, !dbg !132 ; [#uses=1 type=i8] [debug line = 16:21]
  br label %13, !dbg !132                         ; [debug line = 16:21]

branch841:                                        ; preds = %12
  %"a[3].load" = load i8* %"a[3].addr", align 1, !dbg !132 ; [#uses=1 type=i8] [debug line = 16:21]
  br label %13, !dbg !132                         ; [debug line = 16:21]

branch1051:                                       ; preds = %10
  %"a[0].load" = load i8* %"a[0].addr", align 1, !dbg !132 ; [#uses=1 type=i8] [debug line = 16:21]
  br label %11, !dbg !132                         ; [debug line = 16:21]

branch1153:                                       ; preds = %10
  %"a[1].load" = load i8* %"a[1].addr", align 1, !dbg !132 ; [#uses=1 type=i8] [debug line = 16:21]
  br label %11, !dbg !132                         ; [debug line = 16:21]

branch12:                                         ; preds = %10
  %"a[2].load" = load i8* %"a[2].addr", align 1, !dbg !132 ; [#uses=1 type=i8] [debug line = 16:21]
  br label %11, !dbg !132                         ; [debug line = 16:21]
}
...
; [#uses=1]
declare i16 @_ssdm_op_Mux.ap_auto.3i16.i2(i16, i16, i16, i2)
...
!125 = metadata !{i32 11, i32 25, metadata !124, null}
!126 = metadata !{i32 11, i32 48, metadata !123, null}
!127 = metadata !{i32 14, i32 32, metadata !128, null}
!128 = metadata !{i32 786443, metadata !123, i32 14, i32 16, metadata !6, i32 5} ; [ DW_TAG_lexical_block ]
!129 = metadata !{i32 14, i32 49, metadata !130, null}
!130 = metadata !{i32 786443, metadata !128, i32 14, i32 48, metadata !6, i32 6} ; [ DW_TAG_lexical_block ]
!131 = metadata !{i32 15, i32 1, metadata !130, null}
!132 = metadata !{i32 16, i32 21, metadata !133, null}
!133 = metadata !{i32 786443, metadata !134, i32 15, i32 61, metadata !6, i32 8} ; [ DW_TAG_lexical_block ]
!134 = metadata !{i32 786443, metadata !130, i32 15, i32 29, metadata !6, i32 7} ; [ DW_TAG_lexical_block ]
!135 = metadata !{i32 18, i32 7, metadata !130, null}
!136 = metadata !{i32 14, i32 42, metadata !128, null}
!137 = metadata !{i32 786688, metadata !128, metadata !"ki", metadata !6, i32 14, metadata !23, i32 0, i32 0} ; [ DW_TAG_auto_variable ]
