; ModuleID = 'E:/vivado/conv2d/conv2d/solution2/.autopilot/db/a.g.1.bc'
...
define void @conv2d([5 x i8]* %a, [3 x i8]* %b, [3 x i16]* %res) nounwind uwtable {
  ...
  call void (...)* @_ssdm_SpecArrayPartition([3 x i16]* %res, i32 2, i8* getelementptr inbounds ([9 x i8]* @.str, i64 0, i64 0), i32 0, i8* getelementptr inbounds ([1 x i8]* @.str1, i64 0, i64 0)) nounwind, !dbg !43 ; [debug line = 8:1]
  ...
  call void (...)* @_ssdm_SpecArrayPartition([5 x i8]* %a, i32 2, i8* getelementptr inbounds ([9 x i8]* @.str, i64 0, i64 0), i32 0, i8* getelementptr inbounds ([1 x i8]* @.str1, i64 0, i64 0)) nounwind, !dbg !43 ; [debug line = 8:1]
  call void (...)* @_ssdm_op_SpecInterface([3 x i16]* %res, i8* getelementptr inbounds ([1 x i8]* @.str1, i64 0, i64 0), i32 0, i32 0, i8* getelementptr inbounds ([1 x i8]* @.str1, i64 0, i64 0), i32 0, i32 0, i8* getelementptr inbounds ([1 x i8]* @.str1, i64 0, i64 0), i8* getelementptr inbounds ([1 x i8]* @.str1, i64 0, i64 0), i8* getelementptr inbounds ([1 x i8]* @.str1, i64 0, i64 0), i32 0, i32 0, i32 0, i32 0, i8* getelementptr inbounds ([1 x i8]* @.str1, i64 0, i64 0), i8* getelementptr inbounds ([1 x i8]* @.str1, i64 0, i64 0)) nounwind, !dbg !43 ; [debug line = 8:1]
  call void (...)* @_ssdm_op_SpecInterface([3 x i8]* %b, i8* getelementptr inbounds ([1 x i8]* @.str1, i64 0, i64 0), i32 0, i32 0, i8* getelementptr inbounds ([1 x i8]* @.str1, i64 0, i64 0), i32 0, i32 0, i8* getelementptr inbounds ([1 x i8]* @.str1, i64 0, i64 0), i8* getelementptr inbounds ([1 x i8]* @.str1, i64 0, i64 0), i8* getelementptr inbounds ([1 x i8]* @.str1, i64 0, i64 0), i32 0, i32 0, i32 0, i32 0, i8* getelementptr inbounds ([1 x i8]* @.str1, i64 0, i64 0), i8* getelementptr inbounds ([1 x i8]* @.str1, i64 0, i64 0)) nounwind, !dbg !43 ; [debug line = 8:1]
  call void (...)* @_ssdm_op_SpecInterface([5 x i8]* %a, i8* getelementptr inbounds ([1 x i8]* @.str1, i64 0, i64 0), i32 0, i32 0, i8* getelementptr inbounds ([1 x i8]* @.str1, i64 0, i64 0), i32 0, i32 0, i8* getelementptr inbounds ([1 x i8]* @.str1, i64 0, i64 0), i8* getelementptr inbounds ([1 x i8]* @.str1, i64 0, i64 0), i8* getelementptr inbounds ([1 x i8]* @.str1, i64 0, i64 0), i32 0, i32 0, i32 0, i32 0, i8* getelementptr inbounds ([1 x i8]* @.str1, i64 0, i64 0), i8* getelementptr inbounds ([1 x i8]* @.str1, i64 0, i64 0)) nounwind, !dbg !43 ; [debug line = 8:1]
...
; <label>:4                                       ; preds = %3
  ...
  br label %5, !dbg !58                           ; [debug line = 14:32]

; <label>:5                                       ; preds = %9, %4
  %ki = phi i16 [ 0, %4 ], [ %ki.1, %9 ]          ; [#uses=4 type=i16]
  %exitcond1 = icmp eq i16 %ki, 3, !dbg !58       ; [#uses=1 type=i1] [debug line = 14:32]
  br i1 %exitcond1, label %10, label %6, !dbg !58 ; [debug line = 14:32]

; <label>:6                                       ; preds = %5
  call void (...)* @_ssdm_op_SpecLoopName(i8* getelementptr inbounds ([8 x i8]* @.str4, i64 0, i64 0)) nounwind, !dbg !59 ; [debug line = 14:49]
  %rbegin4 = call i32 (...)* @_ssdm_op_SpecRegionBegin(i8* getelementptr inbounds ([8 x i8]* @.str4, i64 0, i64 0)) nounwind, !dbg !59 ; [#uses=1 type=i32] [debug line = 14:49]
  call void (...)* @_ssdm_op_SpecPipeline(i32 1, i32 1, i32 1, i32 0, i8* getelementptr inbounds ([1 x i8]* @.str1, i64 0, i64 0)) nounwind, !dbg !60 ; [debug line = 15:1]
...
!58 = metadata !{i32 14, i32 32, metadata !55, null}
!59 = metadata !{i32 14, i32 49, metadata !54, null}
!60 = metadata !{i32 15, i32 1, metadata !54, null}
